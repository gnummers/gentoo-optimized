...
template <>
class Value<Gio::DBus::ProxyFlags> : public Glib::Value_Flags<Gio::DBus::ProxyFlags>
{
public:
...
public:
   ...
   * 
   * If both DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES and
   * DBUS_PROXY_FLAGS_DO_NOT_CONNECT_SIGNALS are set, this constructor is
