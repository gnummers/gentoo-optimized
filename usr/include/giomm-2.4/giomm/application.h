 ...
 * @newin{2,48}
 * 
 *  @var ApplicationFlags APPLICATION_ALLOW_REPLACEMENT
 * Allow another instance to take over
 * the bus name. @newin{2,60}
 * 
 *  @var ApplicationFlags APPLICATION_REPLACE
...
template <>
class Value<Gio::ApplicationFlags> : public Glib::Value_Flags<Gio::ApplicationFlags>
{
public:
...
//#m4 __CONVERSION(`GVariant*', `const Glib::VariantBase&', `Glib::wrap($3, true)')
   ...
   * is using the APPLICATION_ALLOW_REPLACEMENT flag.
   * 
