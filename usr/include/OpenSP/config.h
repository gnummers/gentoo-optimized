...
#define SGML_CATALOG_FILES_DEFAULT "/etc/sgml/catalog"

/* set this to the default SGML search path */
#define SGML_SEARCH_PATH_DEFAULT "/usr/share/sgml"
...
#define SP_LOCALE_DIR "/usr/share/sgml/opensp-1.5.2/locale"
