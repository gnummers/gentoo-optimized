...
/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstgl_enums.h" */
GST_GL_API
GType gst_gl_texture_target_get_type (void);
#define GST_TYPE_GL_TEXTURE_TARGET (gst_gl_texture_target_get_type())

/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglapi.h" */
GST_GL_API
...
/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglbasememory.h" */
GST_GL_API
...
/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglcontext.h" */
GST_GL_API
GType gst_gl_context_error_get_type (void);
#define GST_TYPE_GL_CONTEXT_ERROR (gst_gl_context_error_get_type())

/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstgldisplay.h" */
GST_GL_API
GType gst_gl_display_type_get_type (void);
#define GST_TYPE_GL_DISPLAY_TYPE (gst_gl_display_type_get_type())

/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglformat.h" */
GST_GL_API
GType gst_gl_format_get_type (void);
#define GST_TYPE_GL_FORMAT (gst_gl_format_get_type())

/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglquery.h" */
GST_GL_API
GType gst_gl_query_type_get_type (void);
#define GST_TYPE_GL_QUERY_TYPE (gst_gl_query_type_get_type())

/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglsl.h" */
GST_GL_API
...
/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglupload.h" */
GST_GL_API
GType gst_gl_upload_return_get_type (void);
#define GST_TYPE_GL_UPLOAD_RETURN (gst_gl_upload_return_get_type())

/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglviewconvert.h" */
GST_GL_API
GType gst_gl_stereo_downmix_get_type (void);
#define GST_TYPE_GL_STEREO_DOWNMIX (gst_gl_stereo_downmix_get_type())

/* enumerations from "/tmp/portage/media-libs/gst-plugins-base-1.16.2/work/gst-plugins-base-1.16.2/gst-libs/gst/gl/gstglwindow.h" */
GST_GL_API
