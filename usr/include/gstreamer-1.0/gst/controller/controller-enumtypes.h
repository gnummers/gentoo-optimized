...
/* enumerations from "/tmp/portage/media-libs/gstreamer-1.16.2/work/gstreamer-1.16.2/libs/gst/controller/gstinterpolationcontrolsource.h" */
GST_CONTROLLER_API
GType gst_interpolation_mode_get_type (void);
#define GST_TYPE_INTERPOLATION_MODE (gst_interpolation_mode_get_type())

/* enumerations from "/tmp/portage/media-libs/gstreamer-1.16.2/work/gstreamer-1.16.2/libs/gst/controller/gstlfocontrolsource.h" */
GST_CONTROLLER_API
