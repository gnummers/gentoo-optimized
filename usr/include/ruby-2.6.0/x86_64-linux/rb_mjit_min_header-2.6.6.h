...
__attribute__((visibility("default"))) int __attribute__((nothrow)) posix_memalign(void **memptr,
...
__attribute__((visibility("default")))
    void __attribute__((nothrow)) *valloc(size_t size)
    __attribute__((malloc));
